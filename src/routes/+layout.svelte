<script lang="ts">
  ...
  import "../app.css";
  import { authHandlers, authStore, memberType } from "../stores/authStore";
...
<body class="h-screen w-screen overflow-clip bg-matteBlack">
  {#if !$page.route.id?.includes("hub")}
    <nav
      class="h-12 bg-[#F94144] text-white w-full flex flex-row items-center justify-between px-4 "
    >
